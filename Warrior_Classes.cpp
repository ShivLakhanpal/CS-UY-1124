...
/*This assignment asked us to create a battle between several warriors and they fought against
each other. Each warrior started out with a certain amount of health but then at the end they fought
each other and some died and some stayed alive.
*/
...
void displayWarriors(const vector<Warrior>& war)
{
	...
	{
		cout << "Warrior: " << war[0].warriorName << ", weapon: " << "Glamdring,"<< war[0].warriorStrength << endl;
		cout << "Warrior: " << war[1].warriorName << ", weapon: " << "Naegling,"<< war[1].warriorStrength << endl;
		cout << "Warrior: " << war[2].warriorName << ", weapon: " << "Excalibur,"<< war[2].warriorStrength << endl;
		cout << "Warrior: " << war[3].warriorName << ", weapon: " << "Narsil,"<< war[3].warriorStrength << endl;
		cout << "Warrior: " << war[4].warriorName << ", weapon: " << "Orcrist,"<< war[4].warriorStrength << endl;
	}
}
